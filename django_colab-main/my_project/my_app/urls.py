...
urlpatterns = [
    ...
    path('delete_all_images/', views.delete_all_images, name='delete_all_images'),  # New URL pattern
    ...
    path('blog_post/create/', blog_post_create, name='blog_post_create'),  # Updated line
